...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/06 22:12:28 by rnaamaou          #+#    #+#             */
/*   Updated: 2022/12/06 22:12:28 by rnaamaou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    *this = old;
    std::cout << "ClapTrap called Copy Constructor called" << std::endl;
}
...
void ClapTrap::attack(const std::string& target)
{
    if (_energy > 0 && _hitPoints > 0)
    {
        ...
        std::cout << "ClapTrap "<< name << " can't attack no energy or healthgit " << std::endl;
...
void ClapTrap::setAttackPoints(unsigned int p)
{
    this->_attackPonits = p;
}

void ClapTrap::setHitPoints(unsigned int p)
{
    this->_hitPoints = p;
}

void ClapTrap::setEnergy(unsigned int p)
{
    this->_energy = p;
}
